        ...
        <div class="box">
          ...
          <div class="columns">
            <div class="column">
              ...
              <div class="info-item has-text-centered">
                <div class="info-icon" style="transform:rotate(${currently.windBearing}deg)">${icons.compass}</div>
              ...
              <div class="info-item has-text-centered">
                ...
                <div class="info-time">${asPercentageText(todaysForecast.humidity)}</div>
              </div>
            </div>
          </div>
          <div class="columns">
                     ...
                     <div class="column">
                       ...
                       <div class="columns">
                         <div class="column">
                           ...
                           <div class="info-item has-text-centered">
                              <div class="info-icon" style="transform:rotate(${f.windBearing}deg)">${icons.compass}</div>
                           ...
                           <div class="info-item has-text-centered">
                             <div class="info-icon">${icons.humidity}</div>
                             <div class="info-time">${asPercentageText(f.humidity)}</div>
                           </div>
                         </div>
                         </div>
                       </div>
